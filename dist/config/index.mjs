...
const config = {
  ...
  db: {
    ...
    username: process.env.DB_USER || 'runebase_explorer',
  ...
  explorerDaemon: {
    path: path.resolve(process.env.EXPLORER_DAEMON_PATH || path.join(__dirname, '../../../runebase-explorer-daemon')),
    wsPort: parseInt(process.env.EXPLORER_DAEMON_WS_PORT || '3001', 10),
    rpc: {
      protocol: process.env.RPC_PROTOCOL || 'http',
      host: process.env.RPC_HOST || 'localhost',
      port: parseInt(process.env.RPC_PORT || '9948', 10),
      user: process.env.RPC_USER || 'runebase',
      password: process.env.RPC_PASS || 'runebase'
    }
  },
