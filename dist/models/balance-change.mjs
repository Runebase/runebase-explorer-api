export default (sequelize, Sequelize) => {
  ...
  BalanceChange.associate = models => {
    ...
    Transaction.hasMany(BalanceChange, {
      as: 'balanceChanges',
      foreignKey: 'transactionId'
    });
    BalanceChange.belongsTo(Transaction, {
      as: 'transaction',
      foreignKey: 'transactionId'
    });
    Address.hasOne(BalanceChange, {
      as: 'balanceChanges',
      foreignKey: 'addressId'
    });
    BalanceChange.belongsTo(Address, {
      as: 'address',
      foreignKey: 'addressId'
    });
    BalanceChange.belongsTo(Header, {
      as: 'header',
