export default (sequelize, Sequelize) => {
  ...
  TransactionOutput.associate = models => {
    ...
    Transaction.hasMany(TransactionOutput, {
      as: 'outputs',
      foreignKey: 'transactionId'
    });
    TransactionOutput.belongsTo(Transaction, {
    ...
    TransactionOutput.belongsTo(TransactionInput, {
      as: 'input',
      foreignKey: 'inputId'
    });
    Address.hasMany(TransactionOutput, {
      as: 'outputTxos',
      foreignKey: 'addressId'
    });
    TransactionOutput.belongsTo(Address, {
      as: 'address',
      foreignKey: 'addressId'
    });
  };
