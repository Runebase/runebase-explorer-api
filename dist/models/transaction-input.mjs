export default (sequelize, Sequelize) => {
  ...
  TransactionInput.associate = models => {
    const {
      Address,
      Transaction,
      TransactionOutput
    } = models;
    Transaction.hasMany(TransactionInput, {
      as: 'inputs',
      foreignKey: 'transactionId'
    });
    TransactionInput.belongsTo(Transaction, {
      as: 'inputTransaction',
      foreignKey: 'transactionId'
    });
    TransactionInput.belongsTo(Transaction, {
    ...
    TransactionInput.belongsTo(TransactionOutput, {
      as: 'output',
      foreignKey: 'outputId'
    });
    Address.hasMany(TransactionInput, {
      as: 'inputTxos',
      foreignKey: 'addressId'
    });
    TransactionInput.belongsTo(Address, {
      as: 'address',
      foreignKey: 'addressId'
    });
  };
